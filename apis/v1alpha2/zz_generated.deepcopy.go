...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in DnsNat46PoolIps) DeepCopyInto(out *DnsNat46PoolIps) {
	{
		in := &in
		*out = make(DnsNat46PoolIps, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DnsNat46PoolIps.
func (in DnsNat46PoolIps) DeepCopy() DnsNat46PoolIps {
	if in == nil {
		return nil
	}
	out := new(DnsNat46PoolIps)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *EgressRouteSpec) DeepCopyInto(out *EgressRouteSpec) {
	*out = *in
	...
	if in.SnatpoolIps != nil {
		in, out := &in.SnatpoolIps, &out.SnatpoolIps
		*out = make(SnatpoolIps, len(*in))
		copy(*out, *in)
	}
	if in.DnsNat46PoolIps != nil {
		in, out := &in.DnsNat46PoolIps, &out.DnsNat46PoolIps
		*out = make(DnsNat46PoolIps, len(*in))
		copy(*out, *in)
	}
	if in.VlanList != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in SnatpoolIps) DeepCopyInto(out *SnatpoolIps) {
	{
		in := &in
		*out = make(SnatpoolIps, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnatpoolIps.
func (in SnatpoolIps) DeepCopy() SnatpoolIps {
	if in == nil {
		return nil
	}
	out := new(SnatpoolIps)
